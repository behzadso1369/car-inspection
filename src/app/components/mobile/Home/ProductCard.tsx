...
export const ProductCard = ({Id,ImagePath,Title,Description,DurationTime}:any) => {
    return (
     ...
     <Link href="/car-inspection" prefetch={false} className="bg-[#416CEA]  w-12 h-12 text-white flex justify-center rounded-full items-center">
  ...
  <figcaption className="mt-10 px-4 flex-1 flex flex-col justify-between relative z-10" key={Id}>
    ...
    <Link href="/car-inspection" prefetch={false} className="rounded-3xl w-full my-4 bg-[#416CEA] text-white px-4 py-2 text-center mt-4">رزرو کارشناسی</Link>
  </figcaption>
</figure>
