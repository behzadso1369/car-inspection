    ...
    return (
        <section className="bg-secondary-background px-4 py-8 font-IranSans">
            ...
            <div className="grid grid-cols-2 gap-6">
                <div>
                    <h3 className="text-[#101117] text-sm text-center py-4 font-semibold">گزارش شفاف و دقیق</h3>
                ...
                <div>
                    <h3 className="text-[#101117] text-sm text-center py-4 font-semibold">کارشناسان معتبر و حرفه‌ای</h3>
                    <p className="text-xs text-[#55565A] text-center leading-6">
                    شبکه‌ای از متخصصان تأییدشده و باتجربه، تا مطمئن باشی انتخابت روی اصوله.
                    </p>
                </div>
                <div>
                    <h3 className="text-[#101117] text-sm text-center py-4 font-semibold">سریع و راحت</h3>
                    <p className="text-xs text-[#55565A] text-center leading-6">
                    ثبت درخواست آنلاین، کارشناسی در محل تو، و تحویل گزارش در کوتاه‌ترین زمان.
                    </p>
                </div>
                <div>
                    <h3 className="text-[#101117] text-sm text-center py-4 font-semibold">صرفه‌جویی در هزینه‌ها</h3>
                    <p className="text-xs text-[#55565A] text-center leading-6">
