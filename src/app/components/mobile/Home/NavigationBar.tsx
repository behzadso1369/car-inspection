...
export const NavigationBar = () => {
    return (
        ...
        <nav className="fixed font-IranSans w-11/12 left-1/2 transform -translate-x-1/2 bottom-12 h-16 px-8 bg-[#f6f6f6] rounded-2xl shadow-[0px_4px_8px_0px_#00000014] flex justify-between items-center">
