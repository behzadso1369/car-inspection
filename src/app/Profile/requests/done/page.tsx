...
export default function DoneRequestDetail() {
 ...
 <figcaption className="mt-4 px-4" key={1}>
   <span className="px-1 text-sm rounded-4xl py-1 mb-2  bg-[#E6FEE6] text-[#2CFF21]">تکمیل شده</span>
   <h5 className="text-[#416CEA] text-sm my-2"> کار شناسی ماشین    سمند سورن </h5>
   <h5 className="text-[#101117] text-base my-2"> وضعیت سفارش : تکمیل سفارش </h5>
   <strong className="text-sm text-[#101117] font-light">در انتظار اعزام کارشناس</strong>
...
<div className="my-4 border-b border-[#DFDFDF] box-border  w-full">
...
<div className="my-4 border-b border-[#DFDFDF] box-content w-full">
    <div className="flex justify-between text-sm my-2">
