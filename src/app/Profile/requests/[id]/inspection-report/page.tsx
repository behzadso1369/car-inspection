                 ...
                 <div className="py-6 font-IranSans px-4 order-0 lg-order-1 col-span-3 lg:col-span-2 lg:border lg:border-[#D9D9D9]  rounded-2xl">
                        ...
                        <div className="flex flex-col md:flex-row gap-6 mb-6">
                            ...
                            <div className="flex-1 grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
                                <div>نام خودرو:</div>
                                <div className="font-bold">سمند</div>
                                <div>رنگ:</div>
                                <div className="font-bold">سفید</div>
                                <div>تاریخ:</div>
                                <div className="font-bold">1404/07/05</div>
                                <div>ساعت:</div>
                                <div className="font-bold">12:14</div>
                                <div>شماره شاسی:</div>
                                <div className="font-bold">147V874</div>
                                <div>پلاک:</div>
                                <div className="font-bold">24 الای 12 ایران 11</div>
                            </div>
                              <div className="flex-shrink-0 flex flex-col items-center w-1/2 py-4 h-[250px]  relative">
                                {/* Car schematic - replace with actual image if available */}
                        ...
                        <div className="flex justify-end">
                            <button className="bg-blue-600 text-white px-5 py-2 rounded hover:bg-blue-700 transition">چاپ گزارش کارشناسی</button>
                        </div>
        </div>
                </div>
