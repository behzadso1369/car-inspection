    ...
    <div className="bg-white font-IranSans lg:px-4 lg:py-4 ">
      <div className="px-4">
        <div className="bg-white px-4 py-6 rounded-3xl my-6">
          ...
          <Input readOnly value={typeof window !== 'undefined' ? localStorage?.getItem("CarGroupName") || '' : ''} onClick={() => setIsOpen(true)} placeholder="نام خودرو را انتخاب کنید" className="items-center !py-4 border border-[#DFDFDF] rounded-full text-[#55565A] text-base" />
        </div>
      </div>
