...
const ADDRESS_INPUT_CLASS =
  "mt-2 h-12 rounded-2xl border-[#DFDFDF] bg-white px-4 text-right text-base text-[#101117] placeholder:text-[#C0C1C5] focus-visible:border-[#416CEA] focus-visible:ring-2 focus-visible:ring-[#416CEA]/15 selection:bg-transparent";
