...
export async function generateMetadata({
  ...
  const url = `${BASE_URL}/car-inspection/${car.slug}`;
    ...
    "@graph": [
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 2, name: "کارشناسی خودروها", item: `${BASE_URL}/car-inspection` },
  ...
  return (
    <div className="px-4 font-IranSans py-4 max-w-5xl mx-auto" dir="rtl">
      ...
      <Breadcrumb
        items={[
          { label: "خانه", href: "/" },
          { label: "کارشناسی خودروها", href: "/car-inspection" },
