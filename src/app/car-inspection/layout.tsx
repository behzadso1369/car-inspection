...
const FLOW_SKELETON_ROUTES = [
  "/car-inspection/inspection-method",
  "/car-inspection/inspection-location",
  "/car-inspection/insert-information",
  "/car-inspection/inspection-time",
  "/car-inspection/final-confirm",
] as const;
...
export default function ProfileLayout({
  ...
  const isBaseFlow = pathname === "/car-inspection";
  ...
  const navigateBack = () => {
    ...
    if (isLoggedIn) {
      if (pathname.startsWith("/car-inspection/inspection-location")) {
        router.replace("/car-inspection/inspection-method");
        return;
      }

      if (pathname.startsWith("/car-inspection/inspection-method")) {
