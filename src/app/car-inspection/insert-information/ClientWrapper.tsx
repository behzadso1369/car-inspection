            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} placeholder="نام و نام خانوادگی" className="px-4 h-12 items-center !py-4 border border-[#DFDFDF] rounded-full text-[#55565A] placeholder:text-[#C5C9D3] text-base" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} placeholder="09123456789" className="px-4 h-12 items-center !py-4 border border-[#DFDFDF] rounded-full text-[#55565A] placeholder:text-[#C5C9D3] text-base" />
                  </FormControl>
